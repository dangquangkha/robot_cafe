...
# === THAY THẾ HÀM start_listening BẰNG 3 HÀM DƯỚI ĐÂY ===
    ...
    def load_products(self):
        ...
        default_products = [
            ...
            # {'id': 2, 'name': 'Cà Phê Đen', 'price': 15000, 'image': 'ca-phe-den-scaled.jpg', 'quantity': 1000, 'type': 'sugar'},
            {'id': 7, 'name': 'Nước Cam Ép', 'price': 10000, 'image': 'orange_juice.png', 'quantity': 100, 'type': 'sugar'},
